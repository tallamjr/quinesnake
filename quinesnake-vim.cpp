...
I>m={{104,1},{'k',/*echo g++ -std=c++11 -oo $I -lcurses -DI=int -DF=if -DK=ret\*/
...
:map<I,I>m={{'j',1},{'k',/*echo g++ -std=c++11 -oo $I -lcurses -DI=int -DF=if -DK
=ret\*/2},{'l',3}};I/*urn -includectime,curses.h,iostream,map,unistd.h|sed s/,/\
